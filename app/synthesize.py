...
def _system_prompt() -> str:
    ...
    return (
        ...
        "the context. This refusal does NOT apply when the context contains market evidence for "
        "that company — answer market/price questions from market chunks regardless of filing coverage.\n"
